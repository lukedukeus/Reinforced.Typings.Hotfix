...
var cliFrameworks = new[] { NET60, NET70 };
var rtFrameworks = new[]  { NET60, NET70};
var taskFrameworks = new[] { NET46, NETSTANDARD20 };

var netCore = new HashSet<string>(new[]{NET60,NET70});
var netCoreApp = new HashSet<string>(new[]{NET60,NET70});
